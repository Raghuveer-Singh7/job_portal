...
<div class="container mb-5">
    <div>
        <h5 class="mt-5 text-center">
            Following are the Recruiters registered with the portal
        </h5>
      
        <table border="1" id="rr" class="display">    <!-- This is a table to dynamically show the jobs posted by this particular recruiter  -->
            <thead>
                <tr>
                    <th>S.no             </th>
...
$(document).ready(function() {
    var table = $('#rr').DataTable({
        ...
        "columns": [
            ...
            { "data": "password" },
            {
              ...
              "render": function(data, type, row, meta) {
                  return '<a href="rr_job.php?id=' + data + '"><button> &nbsp; VIEW &nbsp;</button></a>'; }
    ...
    setInterval(function() {
        $('#rr').DataTable().ajax.reload(null, false);
    }, 3000);
});
